...
with a 3'-5' polymeric linkage of its nucleic backbone replaced by a 2'-3' cyclic terminating linkage \cite{fedor_structure_2000,muller_many_2012}.  
The HpR is not the only ribozyme to be self-reactive, but it was found to be one of the few to be able to do so without requiring any ion\cite{chowrira_extensive_1992, hampel_unique_1997, nesbitt_unusual_1997, young_metal_1997, nesbitt_internal_1999}. 
...
The central step of this transphosphoesterification process is an addition-elimination step, which involved the formation of a pentavalent phosphorus transition state,
and requires the perfect alignment of the nucleophilic group, O2', the central phosphorus and the leaving group, O5'.
...
Mutagenesis experiments \cite{kuzmin_role_2005}, reinforced by structural resolution studies \cite{rupert_crystal_2001,salter_water_2006, spitale_identification_2009, macelrevey_structural_2008},
...
From there, a first mechanistic scenarios was proposed\cite{bevilacqua_mechanistic_2003}: the dianionic scenario proposes that both G8 and A38 are directly involved, 
...
Despite supporting pH-dependency experiments\cite{wilson_nucleobase_2006, kath-schorr_general_2012} and matching transition state arrangements\cite{rupert_transition_2002}, this cleavage scenario suffers from one major inconsistency, 
which is the necessary prior deprotonation but \textit{in-vivo} impractical of the N1 atom of G8 nucleobase\cite{cottrell_ph_2011}.
