...
or by replacing other chemical groups with non-reactive ones, are used to study the catalytic site~\cite{rupert_crystal_2001,salter_water_2006}.
...
Complementary to the X-ray crystal studies, molecular dynamics (MD) expands the knowledge gained through structural resolution
...
First, extended simulation of the full HpR with classical force fields~\cite{mlynsky_extensive_2010, mlynsky_reactive_2015,kumar_mechanistic_2018}, 
...
\cite{mlynsky_comparison_2014, mlynsky_qmmm_2011, nam_electrostatic_2008, nam_electrostatic_2008, kumar_deciphering_2020},
...
as QM/MM simulation require relevant pre-catalytic initial structures 
which can only be obtained from prior robust classical MD simulations.

The classical MD studies are to be classified into two opposing pitches.
The first base iself on study of the catalytic site 
which has been explicitly constrained the catalytic site elements to ensure the formation of a specific H-bond 
network, coherently with the general dianionic scenario: G8:N1···A-1:O2’, A38:N1···G+1:O5’, G8:N2···G+1:Opro-Rp, and A38:N6···G+1:Opro-Rp~\cite{mlynsky_reactive_2015,veenis_investigation_2021}.
Although a certain stability of this local conformation was evaluated within 500~ns of simulation,
we proved in our previous work that the stability of this local arrangement, which we labeled L$_\mathrm{1}$, 
...
L$_\mathrm{2}$, is rather the stable conformation of the hairpin ribozyme in its pre-calaytic state.
These observations are in line with the second pitch which stipulates that this L$_\mathrm{2}$ arrangement,
in which G8 is protonated and distinct from O2' and O2' is involved in a H-bond with the non-brdiging pro-Rp oxygen, 
could be the departure point of the in-line monoanionic scenario. 
Kumar et al. explored the conformational landscape of the catalytic site ounce the O2' proton has been transfered to Opro-Rp, 
and showed that the catalytic site followingly arranges itself perfectly for the upcoming addition-elimination steps,
with the O2'-P-O5' inline attack angle IAA flatter than 140°~\cite{kumar_mechanistic_2018}.
\selrev{Il manque la référence a d'autres articles ou ces états intermédiaires on été étudiés comme~\cite{}}
